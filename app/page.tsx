...
export const metadata: Metadata = {
  ...
  description:
    "Découvrez ce qui performe vraiment sur TikTok. Analysez n'importe quelle niche en quelques secondes : hooks viraux, formats gagnants, hashtags performants.",
  alternates: { canonical: BASE },
  openGraph: {
    url: BASE,
    title: "NicheAnalyze — Analyse TikTok pour créateurs",
    description:
      "Découvrez ce qui performe vraiment sur TikTok. Analysez n'importe quelle niche en quelques secondes.",
  },
};
...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      potentialAction: {
        "@type": "SearchAction",
        target: { "@type": "EntryPoint", urlTemplate: `${BASE}/dashboard/search?q={search_term_string}` },
    ...
    },
    {
      ...
      url: BASE,
      description:
        "Outil d'analyse de niches TikTok pour créateurs de contenu. Analysez hooks, formats, durées et hashtags en temps réel.",
      offers: [
        { "@type": "Offer", name: "Free",    price: "0",     priceCurrency: "EUR" },
        { "@type": "Offer", name: "Pro",     price: "4.99",  priceCurrency: "EUR", billingIncrement: "P1M" },
        { "@type": "Offer", name: "Premium", price: "14.99", priceCurrency: "EUR", billingIncrement: "P1M" },
      ],
      aggregateRating: {
